...
from speechrecog import speech_eng, speech_tr
import random
...
@app.route('/bored')
def bored():
    shock = ["https://hub.kodland.org/en/project/244763", "https://hub.kodland.org/project/243164", "https://hub.kodland.org/project/239630", "https://hub.kodland.org/project/235681", "https://hub.kodland.org/project/219751", "https://hub.kodland.org/en/project/200542"]
    return redirect(random.choice(shock))
